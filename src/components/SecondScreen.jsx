      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div className="relative mt-12 lg:mt-20">
          ...
          <div className="relative grid grid-cols-1 text-center gap-y-12 md:grid-cols-3 gap-x-12">
            {[
              { step: '1', title: 'Select Template', description: 'Select template according to your requirement' },
              { step: '2', title: 'Enter Your Details', description: 'Put in your personalized details and let the AI do the rest.' },
              { step: '3', title: 'Publish it', description: 'Use the output as you like' }
            ].map((item, index) => (
              <div key={index}>
